...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected BOCO and zBOCO supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zBOCOsupply']:
                assert_equal(node['zBOCOsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check BOCO and zBOCO supply at the beginning
        # ------------------------------------------
        # zBOCO supply: 2 coins for each denomination
        ...
        # BOCO supply: block rewards minus burned fees for minting
        ...
        # Verify that BOCO and zBOCO supplies were properly updated after the spends and reorgs
        self.log.info("Check BOCO and zBOCO supply...")
