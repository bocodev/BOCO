...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected BOCO supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check BOCO supply at the beginning
        # ------------------------------------------
        ...
        # Verify that BOCO supplies were properly updated after the spends and reorgs
        self.log.info("Check BOCO supply...")
