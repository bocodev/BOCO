...
"""Verify that starting boco with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start boco with -? for help text")
        ...
        self.log.info("Start boco with -version for version information")
