Contributing to Boco Core
============================

The Boco Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bocodev/BOCO/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Boco Core project, and is not to be
confused with overall Boco Network Protocol consensus changes.

Whether a pull request is merged into Boco Core rests with the project merge
...
Patches that change Boco consensus rules are considerably more involved than
...
Where a patchset proposes to change the Boco consensus, it must have been
...
The project leader is the release manager for each Boco Core release.
