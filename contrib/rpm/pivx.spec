...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/bocod.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/boco-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/boco-qt.1
...
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/boco64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/boco128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/boco256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/boco256.png %{buildroot}%{_datadir}/pixmaps/boco16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/boco256.png %{buildroot}%{_datadir}/pixmaps/boco32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/boco256.png %{buildroot}%{_datadir}/pixmaps/boco64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/boco256.png %{buildroot}%{_datadir}/pixmaps/boco128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/boco256.png %{buildroot}%{_datadir}/pixmaps/boco256.xpm
