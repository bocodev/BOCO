...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='boco.conf'
CONFIGFOLDER='/root/.boco'
COIN_DAEMON='bocod'
COIN_CLI='boco-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/BocoBF/Boco/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
