...
/* Boco GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Boco"
#define QAPP_ORG_DOMAIN "boco.cash"
#define QAPP_APP_NAME_DEFAULT "Boco-Qt"
#define QAPP_APP_NAME_TESTNET "Boco-Qt-testnet"
