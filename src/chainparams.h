...
#define __PORT_MAINNET__ 21778
#define __PORT_TESTNET__ 31778
#define __PORT_REGTEST__ 41778
 ...
 * Boco system. There are three: the main network on which people trade goods
